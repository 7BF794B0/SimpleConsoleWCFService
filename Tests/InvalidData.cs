...
namespace Tests
{
    ...
    {
        [TestMethod]
        public void SendInvalidDataTime()
        {
            try
            {
                ...
                using (var response = (HttpWebResponse)request.GetResponse())
                {
                    ...
                    {
                        Assert.AreEqual("2", streamReader.ReadToEnd());
                    }
                    response.Close();
                }
            }
        ...
        [TestMethod]
        public void SendInvalidDataCoordinates()
        {
            try
            {
                var tel1 = new Telemetry
        ...
        [TestMethod]
        public void SendInvalidDataSpeed()
        {
            try
            {
                var tel1 = new Telemetry
        ...
        [TestMethod]
        public void SendInvalidDataTotalMileageKm()
        {
            try
            {
                var tel1 = new Telemetry
